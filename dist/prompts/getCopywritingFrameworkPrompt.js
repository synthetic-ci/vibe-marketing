...
import { z } from "zod";
export function getCopywritingFrameworkPrompt(copywritingService) {
    return {
        name: "get-copywriting-framework",
        definition: {
            title: "Get Copywriting Framework",
            description: "Guide for using specific copywriting frameworks tailored to different social media platforms",
            argsSchema: {
        ...
        handler: ({ network, framework, context, }) => {
            ...
            const getPlatformConsiderations = () => {
                ...
                return networks
                    ...
                    const consideration = considerations[net.toLowerCase()] ||
