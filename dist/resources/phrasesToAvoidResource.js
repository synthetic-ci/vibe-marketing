export function createPhrasesToAvoidResource(doNotUseData) {
    return {
        uri: "vibe://humanizing/phrases-to-avoid",
        metadata: {
            title: "Phrases to Avoid",
            description: "List of phrases that should be avoided when writing content to make it more human and less AI-like",
