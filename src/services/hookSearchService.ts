import type { HookData, HookResult } from "../types/hooks.js";
...
export class HookSearchService {
	constructor(private hooksData: HookData) {}

	searchHooks(filters: SearchFilters): HookResult[] {
